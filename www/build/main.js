...
var map = {
	...
	"../pages/competition/competition.module": [
		278,
		3
	],
...
var ApiProvider = /** @class */ (function () {
    function ApiProvider(http) {
        this.http = http;
        this.url = 'https://preprod.sgl.cyprx.cloud';
    }
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__models_user_model__ = __webpack_require__(245);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__api_api__ = __webpack_require__(153);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var UserProvider = /** @class */ (function () {
    function UserProvider(api) {
        this.api = api;
    }
    UserProvider.prototype.setUser = function (data) {
        console.log(data);
        this.me = __WEBPACK_IMPORTED_MODULE_1__models_user_model__["a" /* User */].build(data);
        console.log(this.me);
        this.api.post('users', data).subscribe(function (res) {
            console.log(res);
        });
    };
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__providers_user_user__ = __webpack_require__(198);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__providers_api_api__ = __webpack_require__(153);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var User = /** @class */ (function () {
    ...
    User.build = function (data) {
        var mail = data.mail, nickname = data.nickname, lastname = data.lastname, firstname = data.firstname, password_confirmation = data.password_confirmation, birthdate = data.birthdate, address = data.address, gender = data.gender, password = data.password;
        var u = new User;
        u.mail = mail;
        u.nickname = nickname;
        u.lastname = lastname;
...
var MyApp = /** @class */ (function () {
    ...
    MyApp = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({template:/*ion-inline-start:"/Users/sebastienmartin/Documents/SMGL/WEB/web-smgl/src/app/app.html"*/'<menu></menu>\n<ion-nav [root]="rootPage"></ion-nav>\n'/*ion-inline-end:"/Users/sebastienmartin/Documents/SMGL/WEB/web-smgl/src/app/app.html"*/
        }),
